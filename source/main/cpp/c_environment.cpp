...
namespace nenvironment
{
    ...
    float Altitude(float pressure, AltitudeUnit altUnit, float referencePressure, float outdoorTemp, TempUnit tempUnit)
    {
    ...
    float HeatIndex(float temperature, float humidity, TempUnit tempUnit)
    {
        float heatIndex(NAN);
    ...
    float DewPoint(float temp, float hum, TempUnit tempUnit)
    {
